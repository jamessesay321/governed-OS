...
const statusColors: Record<HealthCategory['status'], string> = {
  green: 'text-emerald-600 bg-emerald-50 border-emerald-200',
  amber: 'text-amber-600 bg-amber-50 border-amber-200',
  red: 'text-red-600 bg-red-50 border-red-200',
};

const statusDotColors: Record<HealthCategory['status'], string> = {
  green: 'bg-emerald-500',
  amber: 'bg-amber-500',
  red: 'bg-red-500',
};

function TrendIcon({ trend }: { trend: HealthCategory['trend'] }) {
...
export function HealthClient({ overallScore, categories, hasData }: HealthClientProps) {
      ...
      <div className="mx-auto max-w-5xl space-y-8 p-6 lg:p-8">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-12 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Connect your accounting software to generate your health score.
          </p>
          <Link
            href="/settings"
