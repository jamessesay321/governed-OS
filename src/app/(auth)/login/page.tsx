      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12" style={{ backgroundColor: '#faf8f5' }}>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 h-11 rounded-lg border border-border/60 bg-white text-sm font-medium hover:bg-muted/50 transition-colors"
              style={{ color: '#1c1b1b' }}
            >
