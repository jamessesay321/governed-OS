...
const FINANCE_TASKS: TimesheetTask[] = [
  ...
  { id: 'f4', timestamp: '09:20', endTime: '09:45', durationMinutes: 25, title: 'Daily cash position report', description: 'Generated and distributed to finance team', category: 'reporting', revenueImpact: null, keyAction: false },
...
const SECRETARIAL_TASKS: TimesheetTask[] = [
  ...
  { id: 'sec8', timestamp: '13:45', endTime: '14:15', durationMinutes: 30, title: 'Trademark monitoring', description: 'Scanned UK IPO for similar marks:no conflicts detected for your registered marks', category: 'monitoring', revenueImpact: null, keyAction: false },
