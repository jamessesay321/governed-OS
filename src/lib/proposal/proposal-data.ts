...
export function getMockProposal(): Proposal {
  const items: ProposalItem[] = [
    ...
    // Recommended
    { id: 'finance-agent', type: 'agent', name: 'Finance Agent', description: 'Automated CFO assistant', monthlyPrice: 14900, annualPrice: 149000, included: false, recommended: true, reasoning: 'Your business processes 84+ transactions daily. This agent automates reconciliation, catches duplicates, and manages cash flow forecasting.' },
